...
from Model.CMAT_utils import initialize_weights
from Model.CMAT_utils import initialize_weights
from Model.CMAT_utils import NystromAttention
from Model.CMAT_utils import BilinearFusion
from Model.CMAT_utils import SNN_Block
from Model.CMAT_utils import MultiheadAttention
...
class CMTA(nn.Module):
    def __init__(self, omic_sizes=[81, 301, 496, 419, 1372, 384], n_classes=4, fusion="concat", model_size="small"):
    ...
    def forward(self, **kwargs):
        ...
        x_path = kwargs["wsi_data"].cuda()
        x_omic = [kwargs["gene_list"][i].cuda() for i in range(0, 6)]
        # for i in range(6):
        #     print(x_omic[i].shape)
        # Enbedding
        # genomics embedding
